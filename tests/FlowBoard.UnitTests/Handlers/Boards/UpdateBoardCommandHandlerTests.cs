...
public sealed class UpdateBoardCommandHandlerTests
{
    ...
    private UpdateBoardCommandHandler CreateHandler() =>
    ...
    public async Task Handle_NonMember_Throws404()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() =>
            CreateHandler().Handle(new UpdateBoardCommand(board.Id, "Renamed"), CancellationToken.None));
