...
public sealed class RenameBoardListCommandHandlerTests
{
    ...
    private RenameBoardListCommandHandler CreateHandler() =>
    ...
    public async Task Handle_NonMember_Throws404()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() =>
            CreateHandler().Handle(new RenameBoardListCommand(list.Id, "Renamed"), CancellationToken.None));
