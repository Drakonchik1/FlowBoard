...
public sealed class DeleteBoardListCommandHandlerTests
{
    ...
    private DeleteBoardListCommandHandler CreateHandler() =>
    ...
    public async Task Handle_NonMember_Throws404()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() =>
            CreateHandler().Handle(new DeleteBoardListCommand(list.Id), CancellationToken.None));
